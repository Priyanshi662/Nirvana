...
( () =>
{
  ...
  let navbarContent = `
       <div class="leftSection">
              <a class="flex items-center pb-3 " href="../index.html">
                <img src="../Images/NirvanaLogo.png" alt="Nirvana Logo" class="w-12 h-12 hover:animate-spin " />
                <span
                  class="ml-3 text-base lg:text-2xl uppercase font-semibold projectName tracking-widest ease-in-out duration-300 hover:text-indigo-600">Nirvana</span>
              </a>
  ...
  class="mt-8 newsLetter text-slate-300 flex text-xs flex-col justify-center lg:flex-row lg:justify-between items-center">
    ...
    <p style = "color:white">Get weekly updates regarding Nirvana.</p>
    </div>
...
<button
  ...
  <div class="mt-8 siteNav flex flex-col lg:flex-row ">
    ...
    <div class="flex flex-col lg:flex-row items-center text-center lg:text-left lg:w-1/2">
      <!-- <img src="../Images/New_Logo.svg" alt="Nirvana Logo" class="h-24 w-24 lg:mr-4" /> -->
      <img src="../Images/NirvanaLogo.png" alt="Nirvana Logo" class="h-24 w-24 lg:mr-4 rounded-full" />

      <div class="py-3 font-medium text-white w-2/3 flex flex-col text-xs lg:text-left ">
        <h1 class="text-3xl projectName ">Nirvana</h1>
        <span class="text-sm">
        ...
        <div class="social flex justify-center lg:justify-start items-center gap-x-4 mt-4">
          <a href="https://github.com/akshitagupta15june/Nirvana">
          ...
          <a href="https://twitter.com/ExperienceNirvana">
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor"
  ...
  <!-- Copyright  -->
          <div class="mt-8 copyRight flex items-center justify-center text-xs text-slate-300 flex-col">
            ...
            <p class="text-slate-300  font-bold">
              &copy; <span id="copyright-year"></span> Nirvana. All rights reserved.
            </p>
          </div>
</div>
</footer>
